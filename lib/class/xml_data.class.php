    ...
    public static function catalogs($catalogs)
    {
        ...
        foreach ($catalogs as $catalog_id) {
            ...
            $string .= "<catalog id=\"$catalog_id\">\n" .
                ...
                "\t<last_add>" . $catalog->f_add . "</last_add>\n" .
                "\t<last_clean><![CDATA[" . $catalog->f_clean . "]]></last_clean>\n" .
                "\t<last_update><![CDATA[" . $catalog->f_update . "]]></last_update>\n" .
                "\t<link><![CDATA[" . $catalog->link . "]]></link>\n" .
                "\t<gather_types>" . $catalog->gather_types . "</gather_types>\n" .
                "\t<rename_pattern>" . $catalog->rename_pattern . "</rename_pattern>\n" .
                "\t<sort_pattern>" . $catalog->sort_pattern . "</sort_pattern>\n" .
                "</catalog>\n";
        } // end foreach
